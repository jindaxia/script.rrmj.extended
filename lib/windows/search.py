...
class SearchDialog(kodigui.BaseDialog, windowutils.UtilMixin):
    ...
    SECTION_TYPE_MAP = {
        '1': {'thumb': 'script.rrmj.extended/section_type/movie.png'},  # Movie
        '2': {'thumb': 'script.rrmj.extended/section_type/show.png'},  # Show
        '3': {'thumb': 'script.rrmj.extended/section_type/show.png'},  # Season
        '4': {'thumb': 'script.rrmj.extended/section_type/show.png'},  # Episode
        '8': {'thumb': 'script.rrmj.extended/section_type/music.png'},  # Artist
        '9': {'thumb': 'script.rrmj.extended/section_type/music.png'},  # Album
        '10': {'thumb': 'script.rrmj.extended/section_type/music.png'},  # Track
    }
    ...
    def createListItem(self, hubItem):
        if hubItem.TYPE in ('Genre', 'Director', 'Role'):
            if hubItem.TYPE == 'Genre':
                ...
                mli.setProperty('thumb.fallback', 'script.rrmj.extended/thumb_fallbacks/role.png')
        else:
            if hubItem.TYPE == 'playlist':
                ...
                mli.setProperty('thumb.fallback', 'script.rrmj.extended/thumb_fallbacks/{0}.png'.format(hubItem.playlistType == 'audio' and 'music' or 'movie'))
